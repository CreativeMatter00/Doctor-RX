...
function DiagnosisTable({ setData, reload }) {
	...
	const [diagnosis, isLoading, , refetch] = useFetch(`${process.env.REACT_APP_API_URL}/api/diagnosis`);
	...
	const data = useMemo(() => diagnosis, [diagnosis]);
