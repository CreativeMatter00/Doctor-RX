...
function InvestigationTable({ setData, reload }) {
	...
	const [investigation, isLoading, , refetch] = useFetch(`${process.env.REACT_APP_API_URL}/api/investigation`);
	...
	const data = useMemo(() => investigation, [investigation]);
